% sippscen(SECTION) | User Commands
%
% "July  4 2025"
...
sippscen - program to do something

# SYNOPSIS

**sippscen** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**sippscen** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **sippscen** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**sippscen** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    sippscen. See **foo.conf**(5) for further details.
...
**sippscen** provides some return codes, that can be used in scripts:
